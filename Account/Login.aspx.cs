            ...
            if (IsValid)
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        ...
                        SqlConnection conn = new SqlConnection("Data Source=DESKTOP-3ASQ79G\\SQLEXPRESS01;Initial Catalog=cab_booking;Integrated Security=True;MultipleActiveResultSets=True;");
